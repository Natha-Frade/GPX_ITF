...
async function confirmExport() {
  ...
  try {
    ...
    // o worker do ffmpeg.wasm rejeita com STRING (não com Error): e.message
    // seria undefined e o modal aparecia em branco.
    errorMsg.value = (typeof e === 'string' ? e : e?.message) || String(e) || 'falha desconhecida na exportação'
    phase.value = 'error'
  }
}
